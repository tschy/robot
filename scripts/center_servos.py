...
def smooth_move(channel, target_angle, steps=45, delay=0.03):
    ...
    # Try to read current angle; default to 90 if unknown to safely minimize sudden movement
    ...
    print(f"Gently moving channel {channel} from {current_angle}° to {target_angle}°...")
...
def center_all():
    ...
    print("Done. Servos are centered safely. You can now attach or adjust the leg linkages.")
