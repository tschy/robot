...
def load_robot_config(config_path: str = "config/test_leg_config.json") \
    ...
    controller = ServoController(limits=limits, offsets=offsets)
...
def main():
    ...
    leg_engine, controller, guard = load_robot_config()
    print("Robot system initialized from JSON configuration.")
    ...
    for idx, (target_x, target_y) in enumerate(path_targets):
        ...
        # Check if the coordinate is physically reachable before running math
